...
export async function uploadToR2(
  file: File,
  bucketType: "LECTURES" | "QUIZZES" | "PROFILES" | "PLAYLIST_THUMBNAIL",
  folder: string = ""
): Promise<string> {
...
export async function deleteFromR2(fileUrl: string, bucketType: "LECTURES" | "QUIZZES" | "PLAYLIST_THUMBNAIL"): Promise<void> {
