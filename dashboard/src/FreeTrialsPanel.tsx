            ...
            {filteredStudents.map(student => {
              ...
              return (
                <tr key={student.id}>
                  ...
                  <td>
                    {displayActive ? (
                       <span style={{ color: "var(--emerald-main-main)", fontWeight: "bold", background: "var(--emerald-main-soft)", padding: "4px 10px", borderRadius: "12px", fontSize: "0.8rem", display: "inline-flex", alignItems: "center", gap: "4px" }}>
                         <Check size={12} /> فعالة
                       </span>
                    ) : isActive && hasExpired ? (
                  ...
                  <td>
                    <button 
                       ...
                       style={{ background: displayActive ? "rgba(255, 59, 48, 0.1)" : "var(--emerald-main-soft)", color: displayActive ? "var(--danger)" : "var(--emerald-main-main)" }}
                    >
                      <Power size={18} />
                    </button>
                  </td>
