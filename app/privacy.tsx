...
const content = {
  ar: {
    ...
    intro:
      "نرحب بك في تطبيق معرفة اكاديمي (\"التطبيق\"). نحن نقدر ثقتك ونلتزم بحماية خصوصيتك وبياناتك الشخصية. توضح هذه السياسة كيفية جمع واستخدام وحماية ومشاركة معلوماتك عند استخدامك للتطبيق.",
    footer:
      "باستخدامك لتطبيق معرفة اكاديمي، فإنك توافق على سياسة الخصوصية هذه وتقر بأنك قد قرأتها وفهمت محتواها.",
    sections: [
      {
      ...
      },
      {
        ...
        contact: { app: "معرفة اكاديمي", email: "support@marpha.app" },
      },
    ],
  },
  en: {
